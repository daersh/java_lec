...
import chap01.section01.sorting.Application2;
import chap01.section01.sorting.Application3;
...
public class Application1Tests3 {
    ...
    public void SelectSortTests(int length, int[] actual, int[] expected){
        Application3.solution(actual,length);
